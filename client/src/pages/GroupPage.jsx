  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex-1 overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 mt-16 sm:mt-24">
          <div className="bg-white rounded-xl p-10 sm:p-8">
            <div className="flex items-center space-x-3 mb-6">
              <Users className="h-8 w-8 text-green-600" />
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Create Team</h1>
                <p className="text-sm text-gray-600 mt-1">Assign interns to a new project team</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <select
                  ...
                  className="px-4 py-3 rounded-lg border border-gray-300 text-gray-800 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 outline-none appearance-none min-w-[200px]"
                >
